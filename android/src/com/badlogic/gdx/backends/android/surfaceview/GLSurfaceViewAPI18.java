 ...
 * typically they are called before setRenderer so that they take com.kw.gdx.effect immediately.
 * <p>
...
public class GLSurfaceViewAPI18 extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * of the DEBUG_CHECK_* constants. The debug flags take com.kw.gdx.effect
...
//         * <p>
//         * Typically you will set your viewport here. If your phyWorldCamera
//         * is fixed then you could also set your projection matrix here:
//         * <pre class="prettyprint">
//         * void onSurfaceChanged(GL10 gl, int width, int height) {
//         *     gl.glViewport(0, 0, width, height);
//         *     // for a fixed phyWorldCamera, set the projection too
...
//    }
    ...
    private static class GLThreadManager {
        ...
        /*
         * Tries once to acquire the carRun to use an EGL
         * context. Does not block. Requires that we are already
         * in the sGLThreadManager monitor when this is called.
         *
         * @return true if the carRun to use an EGL context was acquired.
         */
